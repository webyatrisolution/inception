...
class Random_Custom_Background {
	...
	/**
	 * The inceptiontal value of the background position property.  Allowed: 'left', 'right', 'center'.
	 *
	 * @since  0.1.0
	 * @access public
	 * @var    string
	...
	/**
	 * Sets the background inceptiontal position.  Only exectued if using a random background image.
	 *
	 * @since  0.1.0
	 * @access public
	 * @param  string $position_x The background inceptiontal position.
	 * @return string
	 */
